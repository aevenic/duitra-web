	...
	return (
		<div ref={footerRef} className="relative w-full h-[320px] bg-[#212228] overflow-hidden">
			...
			<div className="absolute inset-x-0 top-0 max-w-[1440px] mx-auto h-full pointer-events-none z-0">
				...
				<div
					className="absolute top-12 lg:-top-40 right-10 md:left-4 lg:left-16 xl:left-32 md:w-[85%] h-[200%] lg:h-[300%] pointer-events-none z-0"
			...
			{/* Content Overlay - RESTORED ORIGINAL LAYOUT */}
